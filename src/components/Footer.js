        ...
        <footer className="bg-white ">
            <div className="mx-auto w-full container lg:p-4 p-6 sm:p-6">
                <div className="lg:grid lg:grid-cols-2 block">
                    <div className="mb-6 md:mb-0">
                        <a href="/home" className="items-center">
                            <img src={logo} className="h-8 mb-6" alt="FlowBite Logo" />
                            <p className='font-medium text-lg mb-6'>Online Blood Bank Management System</p>
                        </a>
                    </div>
                    <div className="lg:grid lg:grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 block">
                        <div className='lg:mb-0 mb-8'>
                            <h2 className="mb-6 text-lg font-semibold text-red-700">Supported Links</h2>
                        ...
                        <div className='lg:mb-0 mb-8'>
                            <h2 className="mb-6 text-lg font-semibold text-red-700">Contact Us</h2>
                            <p className='font-medium text-gray-700 text-md'>00233 Drive</p>
                            <p className='font-medium text-gray-700 text-md'>Cape Coast, Ghana</p>
                            <p className='font-medium text-gray-700 text-md'>info@obbms.org</p>
                        </div>
                        <div>
                            <h2 className="mb-6 text-lg font-semibold text-red-700">Legal</h2>
                            <ul className="text-gray-700 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="localhost:3000" className="hover:underline text-md text-gray-700">Privacy Policy</a>
                                </li>
                                <li>
                                    <a href="localhost3000" className="hover:underline text-md text-gray-700">Terms &amp; Conditions</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">OBBMS™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="localhost:3000" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
